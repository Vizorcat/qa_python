...
@pytest.mark.parametrize("initial_favorites, book_to_remove, expected", [
    (["Дюна", "Оно"], "Дюна", ["Оно"]),
    (["Дюна", "Оно"], "Оно", ["Дюна"]),
    (["Дюна", "Оно"], "Такой книги нет", ["Дюна", "Оно"]),
])
def test_delete_book_from_favorites(collector, initial_favorites, book_to_remove, expected):
...
@pytest.mark.parametrize("books, favorites, expected", [
...
@pytest.mark.parametrize("books, expected", [
    ([("Дюна", "Фантастика"), ("Оно", "Ужасы")], {"Дюна": "Фантастика", "Оно": "Ужасы"}),
